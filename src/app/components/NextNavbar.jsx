          ...
          <NavbarItem key={index}>
            <Link
              ...
              className={`transition-all first-letter duration-500 ease-in-out hover:text-blue-800  hover:font-semibold ${
                pathname === link.href ? 'border-b-3 border-primary-focus font-semibold text-blue-900' : ''
              }`}
              color="foreground"
            >
              {link.label}
        ...
        {links.map((link, index) => (
          <NavbarMenuItem key={index}>
            <Link
              ...
              className={`font-semibold text-primary py-4 hover:text-green-800 ${
                pathname === link.href ? 'border-b-3 border-primary-focus' : ''
              }`}
            >
              {link.label}
            </Link>
